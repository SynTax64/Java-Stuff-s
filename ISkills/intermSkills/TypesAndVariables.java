...
public class TypesAndVariables {
	...
	public static void main(String[] args) {
		...
		// Integer (int) - any whole number from roughly -2billion to +2billion (-2^32
		// to 2^32 -1) when signed - 4 bytes
		...
		// Boolean (boolean) - represents true or false (1 or 0) - 1 bit
		...
		String output = String.format("Captain %s %s%s %s, age %d, spent 5 years in space.\n"
				...
				middleInitSymbol, lName, age, numberOfKlingonShipsEncountered, lName, numberOfPlanetsDiscovered,
				wholeKilometersTravelled, numberOfhoursOfService, costOfMission, missionSuccess);
